...
func testSetup() (chan *nats.Msg, chan *nats.Msg) {
	...
	nc.ChanSubscribe("firewall.create.aws.done", doneChan)
	nc.ChanSubscribe("firewall.create.aws.error", errChan)
	...
	Convey("Given an event", t, func() {
		Convey("With valid fields", func() {
			...
			Convey("When completing the event", func() {
				...
				e.Process(valid)
				e.Complete()
				Convey("It should produce a firewall.create.aws.done event", func() {
			...
			Convey("When erroring the event", func() {
				...
				Convey("It should produce a firewall.create.aws.error event", func() {
					msg, timeout := waitMsg(errored)
					So(msg, ShouldNotBeNil)
